...
type Mutation{
    ...
    modifyUser(id: Int, name:String, password: String, newPassword: String, email: String, role: String, address: String, dni: String, phoneNumber: String, twoFA: Boolean): resultUsers
